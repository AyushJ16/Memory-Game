...
const dlButton=document.getElementById('icon');
...
dlButton.addEventListener('click',changemode);
function changemode(){
    document.body.classList.toggle("light-mode");
    document.getElementById("icon").classList.toggle("logo");
    if(document.body.classList.contains("light-mode")){
        document.getElementById("icon").src="public/moon.png";
    }
    else{
        document.getElementById("icon").src="public/sun.png";
    }
